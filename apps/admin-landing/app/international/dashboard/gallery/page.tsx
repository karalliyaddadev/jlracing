...
export default function InternationalGalleryAdminPage() {
  ...
  const fetchItems = useCallback(() => {
    setLoading(true);
    setError(null);
    apiFetch(`/api/gallery?site=FOREIGN`)
      .then((res) => {
      ...
      <div className="gallery-admin__header">
        <div>
          ...
          <p className="gallery-admin__subtitle">
            Manage gallery videos and images for the international frontend
          </p>
        </div>
                  ...
                  {mediaPreview === "video" ? (
                    ...
                    <div className="gallery-admin__current-media">
                      ...
                      <label
                        ...
                        htmlFor="intl-gallery-media-input"
                      >
                        Replace
                      </label>
                    </div>
              ...
              <div className="gallery-admin__field">
                ...
                <div className="gallery-admin__image-picker">
                  {thumbPreview ? (
                    ...
                    <label
                      className="gallery-admin__image-drop"
                      htmlFor="intl-gallery-thumb-input"
                    >
                      <svg
                        width="24"
                        height="24"
