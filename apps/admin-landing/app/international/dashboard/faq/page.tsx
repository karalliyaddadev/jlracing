...
export default function IntlFaqAdminPage() {
  ...
  const fetchCategories = useCallback(() => {
    setLoading(true);
    setError(null);
    apiFetch("/api/faq/categories?site=FOREIGN")
      .then((r) => {
      ...
      <div className="faq-admin__header">
        <div>
          ...
          <p className="faq-admin__subtitle">
            Manage categories and Q&amp;As shown on the international contact
            page
          </p>
        </div>
            ...
            <div className="faq-admin__modal-body">
              ...
              <div className="faq-admin__field">
                <label
                  ...
                  htmlFor="intl-faq-cat-title"
                >
                  Category Title <span className="faq-admin__required">*</span>
                </label>
                <input
                  id="intl-faq-cat-title"
                  className="faq-admin__input"
                  type="text"
                  placeholder="e.g. Getting Started, Shipping & Delivery…"
                  value={catTitle}
              ...
              <div className="faq-admin__field">
                <label
                  className="faq-admin__label"
                  htmlFor="intl-faq-cat-order"
                >
                  Display Order
                </label>
                <input
                  id="intl-faq-cat-order"
        ...
        <div className="faq-admin__overlay" onClick={closeItemModal}>
          ...
          >
            ...
            <div className="faq-admin__modal-body">
              ...
              <div className="faq-admin__field">
                <label className="faq-admin__label" htmlFor="intl-faq-item-q">
                ...
                <input
                  ...
                  className="faq-admin__input"
                  type="text"
                  placeholder="e.g. How do I start importing a vehicle?"
                  value={itemQuestion}
              ...
              <div className="faq-admin__field">
                <label className="faq-admin__label" htmlFor="intl-faq-item-a">
              ...
              <div className="faq-admin__row-2">
                <div className="faq-admin__field">
                  <label
                    className="faq-admin__label"
                    htmlFor="intl-faq-item-order"
                  >
                    Display Order
                  </label>
                  <input
                    id="intl-faq-item-order"
                    className="faq-admin__input faq-admin__input--sm"
                    type="number"
                    min={0}
                    value={itemOrder}
