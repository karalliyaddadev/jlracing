...
export default function ListingDetailPage() {
  ...
  useEffect(() => {
    if (!id) return;
    fetch(`${CMS_API_URL}/api/listings/${id}`)
      .then((res) => {
      ...
      <div className="bikedetail-container">
        ...
        <div className="bikedetail__layout">
          ...
          <div className="bikedetail__info">
            ...
            {vehicle.year && <p className="bikedetail__year">{vehicle.year} Model</p>}

            <p className="bikedetail__price">{formatPrice(vehicle.price)}</p>
            ...
            <div className="bikedetail__specs">
              {specs.map((s) => (
                <div key={s.label} className="bikedetail__spec-item">
                  ...
                  <span className="bikedetail__spec-value">{String(s.value)}</span>
                </div>
              ))}
            </div>
            ...
            <div className="bikedetail__actions">
              <Link href="/contact" className="bikedetail__btn bikedetail__btn--primary">
                Inquire Now
              </Link>
              <a
                href={WHATSAPP_LINK}
