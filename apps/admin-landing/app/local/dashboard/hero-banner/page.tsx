...
/** One draft entry in the "Add Slides" multi-upload modal */
      ...
      <div className="hero-admin__header">
        <div>
          ...
          <p className="hero-admin__subtitle">
            Manage carousel slides for the local frontend homepage
          </p>
        </div>
